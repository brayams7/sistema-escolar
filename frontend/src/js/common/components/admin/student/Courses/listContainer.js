...
import { actions } from '../../../../../redux/modules/admin/student/coursesStudent';
import ListCoursesStudents from './listStudentAsignation';
...
export default connect(ms2p, md2p)(ListCoursesStudents);