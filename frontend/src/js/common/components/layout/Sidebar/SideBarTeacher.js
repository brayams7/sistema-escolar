                ...
                <div className="nav-wrapper">
                    <ul className="nav--no-borders flex-column nav">
                        <li className="nav-item">
                            <NavLink to="/indexTeacher" exact className="nav-link " activeClassName={'active'}>
                        ...
                        <li className="nav-item">
                            <NavLink to="/coursesTeacher" className="nav-link" activeClassName={'active'}>
                                <div className="d-inline-block item-icon-wrapper">
                        ...
                        <li className="nav-item">
                            <NavLink to="/eventOnlyRead" className="nav-link" activeClassName={'active'}>
                                <div className="d-inline-block item-icon-wrapper">
