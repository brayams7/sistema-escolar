                ...
                <div className="nav-wrapper">
                    <ul className="nav--no-borders flex-column nav">
                        <li className="nav-item">
                            <NavLink to="/indexAdmin" exact className="nav-link " activeClassName={'active'}>
                        ...
                        <li className="nav-item">
                            <NavLink to="/profession" className="nav-link" activeClassName={'active'}>
                                <div className="d-inline-block item-icon-wrapper">
                        ...
                        <li className="nav-item">
                            <NavLink to="/teacher" className="nav-link" activeClassName={'active'}>
                                <div className="d-inline-block item-icon-wrapper">
                                    <i className="material-icons">vertical_split</i>
                                </div>
                        ...
                        <li className="nav-item">
                            <NavLink to="/asignation" className="nav-link" activeClassName={'active'}>
                                <div className="d-inline-block item-icon-wrapper">
                                    <i className="material-icons">vertical_split</i>
                                </div>
                        ...
                        <li className="nav-item">
                            <NavLink to="/grades" className="nav-link" activeClassName={'active'}>
                                <div className="d-inline-block item-icon-wrapper">
                                    <i className="material-icons">vertical_split</i>
                                </div>
                                <span>Grados</span>
                        ...
                        <li className="nav-item">
                            <NavLink to="/level" className="nav-link" activeClassName={'active'}>
                                <div className="d-inline-block item-icon-wrapper">
                                    <i className="material-icons">vertical_split</i>
                                </div>
                                <span>Niveles</span>
